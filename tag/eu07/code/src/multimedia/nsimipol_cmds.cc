...
static void n_setipoltype(void *o, nCmd *cmd)
{
    ...
    nSimIpol::nIpolType t;
    if      (strcmp(s,"step")==0)       t=nSimIpol::N_STEP;
    else if (strcmp(s,"linear")==0)     t=nSimIpol::N_LINEAR;
    else if (strcmp(s,"quaternion")==0) t=nSimIpol::N_QUATERNION;
    else if (strcmp(s,"cubic")==0)      t=nSimIpol::N_CUBIC;
    else if (strcmp(s,"spline")==0)     t=nSimIpol::N_SPLINE;
    else {
...
{
    nSimIpol *self = (nSimIpol *) o;
    nSimIpol::nIpolType t = self->GetIpolType();
    const char *s;
    switch (t) {
        case nSimIpol::N_STEP:        s="step"; break;
        case nSimIpol::N_QUATERNION:  s="quaternion"; break;
        case nSimIpol::N_CUBIC:       s="cubic"; break;
        case nSimIpol::N_SPLINE:      s="spline"; break;
        case nSimIpol::N_LINEAR:      
...
//-------------------------------------------------------------------
bool nSimIpol::SaveCmds(nPersistServer *fs)
{
    bool retval = false;
