...
set release_cpp_flags "/nologo /vmb /vms /Gy /GF /MD /W3 /GX- /G6 /Ob2 /Og /Oi /Os /Oy /YX /FD /c /DWIN32 /D__WIN32__ /DNDEBUG /D__NEBULA_MEM_MANAGER__ /DNT_PLUGIN /I..\\inc /Tp"
set debug_cpp_flags   "/nologo /vmb /vms /MDd /W3 /GX- /Gm /YX /FD /ZI /Od /GZ /c /DWIN32 /D__WIN32__ /D_DEBUG /D__NEBULA_MEM_MANAGER__ /DNT_PLUGIN /I..\\inc /Tp"
...
proc gen_package_dsp {name} {
    ...
    puts $cid "PostBuild_Cmds=tclsh84 ..\\src\\gentocfile.tcl $name win32 release"
    ...
    puts $cid "SOURCE=\"\$(InputPath)\""
    puts $cid "PostBuild_Desc=Generating TOC file $name.toc"
    puts $cid "PostBuild_Cmds=tclsh84 ..\\src\\gentocfile.tcl $name win32 debug"
    puts $cid "# End Special Build Tool"
    puts $cid ""
    puts $cid "!ENDIF"
    puts $cid ""
