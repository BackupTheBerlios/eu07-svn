...
set release_preprocessor_defs "WIN32;NDEBUG;NT_PLUGIN;__WIN32__"
set debug_preprocessor_defs "WIN32;_DEBUG;NT_PLUGIN;__WIN32__"
...
proc gen_package_vcproj {name} {
    ...
    for {set j 0} {$j < [llength $tar($i,libs_win32)]} {incr j} {
        ...
        set lib_file "[lindex $tar($i,libs_win32) $j]"
		if       { $lib_file == "osg.lib" } {
			set lib_file "osgd.lib"
		} elseif { $lib_file == "osgDB.lib" } {
			set lib_file "osgDBd.lib"
		} elseif { $lib_file == "osgUtil.lib" } {
			set lib_file "osgUtild.lib"
		} elseif { $lib_file == "osgSim.lib" } {
			set lib_file "osgSimd.lib"
		} elseif { $lib_file == "OpenThreadsWin32.lib" } {
			set lib_file "OpenThreadsWin32d.lib"
		} 
        addtolist libsd "$lib_file"
    ...
    puts $cid "				RuntimeTypeInfo=\"TRUE\""
    puts $cid "				UsePrecompiledHeader=\"2\""
    ...
    puts $cid "				AdditionalDependencies=\"$libsd\""
    ...
    puts $cid "				CommandLine=\"tclsh84 ..\\src\\gentocfile.tcl $name win32 debug\"/>"
    puts $cid "			<Tool"
    ...
    puts $cid "				Name=\"VCPostBuildEventTool\""
    puts $cid "				Description=\"Generating TOC file $name.toc\""
    puts $cid "				CommandLine=\"tclsh84 ..\\src\\gentocfile.tcl $name win32 release\"/>"
    puts $cid "			<Tool"
    puts $cid "				Name=\"VCPreBuildEventTool\"/>"
    puts $cid "			<Tool"
    puts $cid "				Name=\"VCPreLinkEventTool\"/>"
