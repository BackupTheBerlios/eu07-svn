...
*/
	...
	osg::ref_ptr<osg::MatrixTransform> atmoRoot;
	osg::ref_ptr<osg::Geode> particlesRoot;
...
public:
	...
	virtual osg::Group *getDynamicModelsRoot() { return dynamicModelsRoot.get(); };
	virtual osg::Group *getAtmoRoot() { return atmoRoot.get(); };
    // inherited
	...
	virtual void LoadSceneGraph(const char *name);
	virtual void AddSceneGraph(osg::Node *node);

//	inline osgUtil::SceneView 
/*
...
*/
	virtual void SetViewMatix(osg::Matrixd &mat);
	virtual void SetProjectionMatix(osg::Matrixd &mat);
    // Text-Support
