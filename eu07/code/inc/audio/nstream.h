...
public:
	...
	void SetLooping(bool l) { isLooping= l; };

	virtual int GetLength() { return 0; };

//	inline void SetStartFile(const char *name) { startFileName= name; };
//	inline void SetStopFile(const char *name) { stopFileName= name; };
...
protected:
    ...
    nString fileName;
//    nString startFileName;
  //  nString stopFileName;
