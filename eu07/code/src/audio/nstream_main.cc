...
/**
*/
void nStream::SetStartOffset(int offset)
{
	startOffset= (offset*this->baseFreq*2)/1000; 
}

//------------------------------------------------------------------------------
/**
*/
void nStream::SetStopOffset(int offset)
{
	if (offset>0)
		stopOffset= GetLength()-(offset*this->baseFreq*2)/1000; 
	else
		stopOffset= 0;
}
